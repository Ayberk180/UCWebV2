  ...
  return (
    <div className='flex flex-col my-8'>
        ...
        <div className='grid grid-cols-4 justify-items-center space-between'>
            <Link href={'/contact'}>
                <div className='flex flex-col justify-center w-56 h-40 shadow-md rounded-2xl hover:shadow-2xl bg-wisp-pink'>
                    <p className='text-2xl font-semibold text-center text-blue-magenta'>Contact Us</p>
                    <p className='text-center text-dark-gray'>This is a test for the thing testing</p>
                </div>
            </Link>
            <Link href={'/services'}>
                <div className='flex flex-col justify-center w-56 h-40 shadow-md rounded-2xl hover:shadow-2xl bg-wisp-pink'>
